...
<table id='referral_rep_grid' class='sales_rep_grid' cellspacing='0' cellpadding='0'>
    <tr id="gridHead" class="gridHead">
        <th id="gridHead_col_0" class="gridHead_First_col">Ref. R.ID</th>
...
<script type="text/javascript">
    $("table#referral_rep_grid tr:even").css("background-color", "#f5f5f5");
    $("table#referral_rep_grid tr:odd").css("background-color", "#E5E5E5");   
    $("table#referral_rep_grid th").css("background-color", "black");
</script>    