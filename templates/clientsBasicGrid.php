...
<table id='clientsBasic_grid' class='sales_rep_grid' cellspacing='0' cellpadding='0'>
...
<script type="text/javascript">
    $("table#clientsBasic_grid tr:even").css("background-color", "#f5f5f5");
    $("table#clientsBasic_grid tr:odd").css("background-color", "#E5E5E5");   
    $("table#clientsBasic_grid th").css("background-color", "black");
</script>    